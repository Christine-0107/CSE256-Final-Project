...
class VLTVG(nn.Module):
    def __init__(self, pretrained_weights, args=None):
        ...
        # Text and OCR feature encoder (BERT)
        print("args:", args)
    ...
    def forward(self, image, image_mask, word_id, word_mask, ocr_id, ocr_mask):
        ...
        ocr_id_1 = ocr_id[:, :512]
        ocr_mask_1 = ocr_mask[:, :512]
        ocr_id_2 = ocr_id[:, 512:1024]
        ocr_mask_2 = ocr_mask[:, 512:1024]
        ocr_id_3 = ocr_id[:, 1024:]
        ocr_mask_3 = ocr_id[:, 1024:]
        ...
        ocr_feat = ocr_feat.permute(1, 0, 2) # NxLxC -> LxNxC  修改！！！
        ocr_mask = ~ocr_mask
        # print("=========ocr=======")
        # print(ocr_feat.size(), ocr_mask.size())
